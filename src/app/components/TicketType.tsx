    ...
    return (
        <div className="space-y-2">
            ...
            <div className="flex flex-wrap justify-center gap-4 p-4 border border-[#07373F] rounded-[24px] bg-[#052228]">
                {
                    TICKET_TYPE.map((ticket, index) => <button onClick={()=> getTicketType(ticket.access)} key={index} className="w-[158px] max-[521px]:w-full p-3 rounded-xl flex gap-3 flex-col justify-between items-start border border-[#197686] hover:bg-[#197686]">
